...
function App() {
  ...
  return (
    <>
      <div className="h-screen w-screen flex flex-col text-white items-center gap-7">
        <h1 className="text-4xl font-bold text-center mt-4 font-custom text-teal-950 sm:mt-8">Task Management</h1>
